...
This repository was generated by Reyna Jenkyns as part of a Data Wrangling and Versioning workshop, which took place at the [Canadian Data Curation Forum](https://data-curation.github.io/).
...
Software- or Instrument-specific information needed to interpret the data, including software and hardware version numbers: OpenRefine, text editor

Standards and calibration information, if appropriate:

Environmental/experimental conditions:

Describe any quality-assurance procedures performed on the data: Used OpenRefine to identify errors and clean special characters in cell. The script.txt file depicts those changes applied from the original CSV input to the final CSV output. 
